            ...
            <header class='main-wrapper header'>
                <div class="container apex">
                    <span class="contact-header pull-left small_font">
                        Contact: +555 4611 655 - Monday to Friday
                    </span>
                ...
                <div class="container end-header">
                    <div class="logo pull-left">
                        <a href="#" class='pull-left'>
                            <img src="assets/images/logo.png" alt="Advisio" title="Advisio">
                        </a>
            ...
            <section class='main-wrapper content'>
                        ...
                        <ul class="form-bxslider unstyled">
                            <li>
                                ...
                                <div class="img-slider slide-man1 fin_2">
                                    <img src="assets/images/staticks/slider_man1.png" alt="alt text...">
                                </div>
                            </li>
                            <li>
                                <div class="list-forstart fin_1">
                                ...
                                <div class="img-slider slide-man2 fin_2">
                                    <img src="assets/images/staticks/slider_man2.png" alt="alt text...">
                                </div>
                            </li>
                            <li>
                                <div class="list-forstart fin_1">
                                ...
                                <div class="img-slider slide-man3 fin_2">
                                    <img src="assets/images/staticks/slider_man3.png" alt="alt text...">
                                </div>
                            </li>
                        </ul>
                        ...
                        <div class="span6">
                            <figure class='media-news'>
                                <a href='http://www.youtube.com/embed/VOJyrQa_WR4?rel=0&amp;wmode=transparent' class="group1" title='This is title text'>
                                    <img src="assets/images/staticks/pop4.jpg" alt="alt..." >
                                    <i class="zoom-ico"></i>
                                </a>
                            </figure>
                        </div>
                ...
                <div class="container">
                    <div class="row intensified-row">
                        ...
                        <div class="span6">
                            <figure class='media-news'>
                                <a href="assets/images/staticks/fullsize/img_2.jpg" class="group3" title='There can be written anything'>
                                    <img src="assets/images/staticks/pop5.jpg" alt="alt..." >
                ...
                <div class="container">
                    <div class="row intensified-row">
                        <div class="span6">
                            <figure class='media-news'>
                                <a href="assets/images/staticks/fullsize/img_3.jpg" class="group3" title='This is title text'>
                                    <img src="assets/images/staticks/pop6.jpg" alt="alt..." >
                                    <i class="zoom-icoBw"></i>
                                </a>
                            </figure>
                        </div>
                        ...
                        <div class="span6">
                            <h2 class='xh-Bold'>The best Advisio in next year</h2>
                            <div class="excerpt">
                ...
                <div class="container" data-anchor="gallery">
                    ...
                    <div class="row intensified-row" id='gallery'>
                        <div class="span6">
                            <figure class='media-news'>
                                <a href="assets/images/staticks/fullsize/img_1.jpg" class="group2 bwWrapper">
                                    <img src="assets/images/staticks/pop4.jpg" alt="alt..." >
                                    <i class="zoom-icoBw"></i>
                                </a>
                            </figure>
                        ...
                        <div class="span6">
                            <figure class='media-news'>
                                <a href="assets/images/staticks/fullsize/img_5.jpg" class="group2 bwWrapper">
                                    <img src="assets/images/staticks/pop1.jpg" alt="alt..." >
                                    <i class="zoom-icoBw"></i>
                                </a>
                            </figure>
                        </div>
                        ...
                        <div class="span6">
                            <figure class='media-news'>
                                <a href="assets/images/staticks/fullsize/img_6.jpg" class="group2 bwWrapper">
                                    <img src="assets/images/staticks/pop2.jpg" alt="alt..." >
                                    <i class="zoom-icoBw"></i>
                                </a>
                            </figure>
                        </div>
                        ...
                        <div class="span6">
                            <figure class='media-news'>
                                <a href="assets/images/staticks/fullsize/img_7.jpg" class="group2 bwWrapper">
                                    <img src="assets/images/staticks/pop3.jpg" alt="alt..." >
                                    <i class="zoom-icoBw"></i>
                                </a>
                            </figure>
                        </div>
                ...
                <div class="partners">
                    <div class="container">
                        ...
                        <ul class='offset4 unstyled partnersList'>
                            <li>
                                <a href="#"><img src="assets/images/staticks/sponsor1.png" alt="alt..."></a>
                            </li>
                            <li>
                                <a href="#"><img src="assets/images/staticks/sponsor2.png" alt="alt..."></a>
                            </li>
                            <li>
                                <a href="#"><img src="assets/images/staticks/sponsor3.png" alt="alt..."></a>
                            </li>
                            <li>
                                <a href="#"><img src="assets/images/staticks/sponsor4.png" alt="alt..."></a>
                            </li>
                            <li>
                                <a href="#"><img src="assets/images/staticks/sponsor5.png" alt="alt..."></a>
                            </li>
                        </ul>
                    </div>
                </div>
